...
var encKey = process.env.ENC_KEY || 'enterakey';
...
//var oldClientSeed = '462CD145BD02FC293518C320F1224E40BE9D433DEAF0EE180631C71FFDA1A2DC';
var clientSeed = '0000000000000000002534354a0789d021910c4def80c705e36a33820c6166c7'

exports.crashPointFromHash = function(serverSeed) {
    var hash = crypto.createHmac('sha256', serverSeed).update(clientSeed).digest('hex');


    if (divisible(hash, 36))
        return 0;
